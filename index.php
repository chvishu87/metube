...
?>
        ...
        <h1>MeTube</h1>
	<form id=myform method="post" action="<?php echo "index.php"; ?>">
	...
	<table width="100%">
		...
		<tr>
			...
			<td><input name="submit" type="submit" value="Login"><input name="reset" type="reset" value="Reset"><input name="register" type="submit" value="registera" onclick="document.forms['myform'].action='register.php'"><br /></td>
		</tr>
	</table>
	</form>
